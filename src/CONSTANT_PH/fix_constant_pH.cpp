...
static constexpr double environment_coupling = 0.00; // Coupling coefficient for the environment term
...
void FixConstantPH::init()
{
  ...
  s = 0.3;  // 0.3;//0.3;
  h = 7.0;  // 10; //7.0;
  k = 0.0; //2.553; //4.417; // 6.267; //4.417;       //2.553;
  ...
  d = 0.0;//2.0; //3.5; // 5.0; //3.50;    //2.0; //The height of the barrier is 2*d
